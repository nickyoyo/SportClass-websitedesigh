...
<html>
    ...
    <body>             <div  style="height:50px; padding:20px;" align="center">     
       <img src="topic2.jpg"  width="100" height="100"> <br>  
        <b><font face="Microsoft JhengHei" size="5">歷史課程紀錄</b></font>   
...
while($data = mysqli_fetch_array($resulta)){  
  ...
  for($i=0;$i<$dataname;$i++){
     ...
     if(strtotime($savedatabase[$i][0])<strtotime("now")){
      ...
      echo "<a href=\"historyclassmember_1.php?dataclass=".$savedatabase[$i][3]."\">學員名單</a>";
  ...
  if($count1===0){ 
   ...
   echo '<p><a href="teacherclassrecord.php">回課程紀錄</a>  <br><br>';
?>
